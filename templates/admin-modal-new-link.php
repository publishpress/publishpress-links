    ...
    <form class="tinypress-popup-box" action="" method="post">
        <div class="popup-content">
            <div class="tinypress-logo">
                <a target="_blank" href="<?php echo TINYPRESS_LINK_PRO . '?ref=' . site_url(); ?>"><img src="<?php echo esc_url( TINYPRESS_PLUGIN_URL . 'assets/images/publishpresslinks.svg' ); ?>" alt="<?php esc_attr_e( 'tinyPress logo', 'tinypress' ); ?>"></a>
            </div>
